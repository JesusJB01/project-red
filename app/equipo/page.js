...
export const Team = [
  ...
  { name: "Alice Smith", position: "Designer" },
  { name: "Bob Johnson", position: "Developer" },
  { name: "Eva Williams", position: "Marketing Manager" },
  { name: "Michael Brown", position: "Sales Director" },
  { name: "Sophia Lee", position: "HR Manager" },
];
